package com.imcys.deeprecopy.common.viewmodel
...
import com.imcys.deeprecopy.common.viewmodel.info.IViewModelHandle
import com.imcys.deeprecopy.common.viewmodel.info.UiIntent
import com.imcys.deeprecopy.common.viewmodel.info.UiState
...
abstract class ComposeBaseViewModel<S : UiState, I : UiIntent>(viewState: S) :
     ...
     * 发送意图
     */
    internal fun sendIntent(viewIntent: I) {
        viewModelScope.launch(Dispatchers.IO) {
